...
var Player = function (props) {
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement("div", { className: "player" },
            playerScore,
            React.createElement("div", { className: "cards" }, playerCards.map(function (index) { return (React.createElement(Card_js_1["default"], { pile: "player", isTopCard: index === playerCards[playerCards.length - 1], key: index, id: index, from: "player" })); })))));
};

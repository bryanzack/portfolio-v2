...
var Card = function (props) {
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement(web_1.animated.div, { className: (props.pile === "player" || props.pile === "dealer") ? "card-container-hand" : "card-container", style: (0, web_1.useSpring)((0, processCard_js_1["default"])(props.pile, props.from)) },
            React.createElement("img", { className: "card-back", src: "../../static/svg_playing_cards/fronts/png_96_dpi/".concat(cards_1["default"][props.id].path, ".png"), alt: "card", height: "130px", width: "100px" }),
            React.createElement("img", { className: "card-front", src: "../../static/svg_playing_cards/backs/png_96_dpi/".concat(card_theme, ".png"), alt: "card", height: "130px", width: "100px" }))));
};
